...
def build_report(target_date: date):
    ...
    with open(md_path, "w", encoding="utf-8") as f:
        ...
        if week_num == 37:
            f.write(f"- **Build 1-2 第一建構期第二週扎實推進**：週一完全休息超補償後，週二晨跑超額達標 (12.5km)、週三長池甜甜長游高效巡航 (3.15km)、週四單車 TEMPO 3x18' 完美吃下 (42.8km)、週五長池甜甜長游高水準達標 (3.25km)、週六北海岸長騎 59.6km ＋ 轉換跑 9.73km (60分鐘) 關鍵雙課表圓滿達成！本週已累積自行車 **{bike_act_km:.2f} km**、跑步 **{run_act_km:.2f} km**、游泳 **{swim_act_km:.2f} km**，三項總時長達 **{(total_actual_time/60.0):.1f} 小時** (整體時間執行率達 **{overall_completion:.1f}%**)，三項總負荷強勢突破 **585+ TSS**！\n")
            ...
            f.write("- **週三 50m長池甜甜泳課 3,150m 高效巡航 (104.9 sTSS)**：9/9 游泳 59 分 07 秒完成 3,150m (均速 1:53.0/100m, 均時速 3.19 km/h, 均心率 111 bpm, 最高 184 bpm, IF 1.02, 體感自覺滿分 5/5 ｜ RPE 3/10, 消耗 632 kcal)，有氧脫鉤率 Spd:HR 僅 0.34% 展現極高心肺效率與水感零漂移！均速 1:53/100m 完全契合 Sub-11 完賽目標配速線 (1h12m / 1:53/100m)，且均心率僅 111 bpm (恢復與耐力區間佔比高達 86%)，以極低心肺代價發揮出色的下肢動態排酸，同時高效累積超過 100 點負荷！\n")
    ...
    if week_num == 37:
        p1_body.add_run(f"• Build 1-2 第一建構期第二週扎實推進：週一完全休息超補償後，週二晨跑超額達標 (12.5km)、週三長池甜甜長游高效巡航 (3.15km)、週四單車 TEMPO 3x18' 完美吃下 (42.8km)、週五長池甜甜長游高水準達標 (3.25km)、週六北海岸長騎 59.6km ＋ 轉換跑 9.73km (60分鐘) 關鍵雙課表圓滿達成！本週已累積自行車 {bike_act_km:.2f} km、跑步 {run_act_km:.2f} km、游泳 {swim_act_km:.2f} km，三項總時長達 {(total_actual_time/60.0):.1f} 小時 (整體時間執行率達 {overall_completion:.1f}%)，三項總負荷強勢突破 585+ TSS！\n")
