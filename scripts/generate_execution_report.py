...
def build_report(target_date: date):
    ...
    with open(md_path, "w", encoding="utf-8") as f:
        ...
        if week_num == 34:
            ...
            f.write("- **Build 1-1 第一建構期旗開得勝**：本週正式邁入專項建構期，截至週三已完成游泳 **3.45 km (70 分鐘)**、單車 **17.32 km (35 分鐘)**、跑步 **12.04 km (99 分鐘)**，三項累積 **211.0 TSS**，專項速度、耐力、流線水感與踩踏節奏建構全面開展！\n")
            ...
            f.write("- **週二 17.32km 單車 TEMPO 8X3 階梯間歇踩踏**：9/1 傍晚單車 35 分鐘 (均速 29.35 km/h, 均瓦 137W, 踏頻 82 rpm, 均心 137 bpm, 34.2 TSS)，3 組階梯推進 (171W -> 184W -> 204W 閾值衝刺) 踩踏效率極佳。\n")
        elif week_num == 35:
    ...
    if week_num == 34:
        ...
        p1_body.add_run("• Build 1-1 第一建構期旗開得勝：本週正式邁入專項建構期，截至週三已完成游泳 3.45 km (70 分鐘)、單車 17.32 km (35 分鐘)、跑步 12.04 km (99 分鐘)，三項累積 211.0 TSS，專項速度、耐力、流線水感與踩踏節奏建構全面開展！\n")
        ...
        p1_body.add_run("• 週二 17.32km 單車 TEMPO 8X3 階梯間歇踩踏：9/1 傍晚單車 35 分鐘 (均速 29.35 km/h, 均瓦 137W, 踏頻 82 rpm, 均心 137 bpm, 34.2 TSS)，3 組階梯推進 (171W -> 184W -> 204W 閾值衝刺) 踩踏效率極佳。\n")
    elif week_num == 35:
