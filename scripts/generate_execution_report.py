...
def build_report(target_date: date):
    ...
    if week_num == 38:
        p1_body.add_run(f"• Build 1-3 第一建構期巔峰週展開 (Peak Build Phase)：本週為第一建構期負荷最高峰，全週排定總訓練時長達 14.9 小時。截至目前已累積自行車 {bike_act_km:.2f} km (0.67 小時)、跑步 {run_act_km:.2f} km (1.41 小時)，整體時間執行率達 {overall_completion:.1f}%。\n")
        p1_body.add_run("• 週二下午室內單車 Threshold 5X3 18.76km (36.0 TSS)：9/15 下午 15:22 順利完成 40 分 22 秒室內單車課表 (原定 40 分鐘，時間達成率 100.9% 精準達標)。距離 18.76 km、爬升 76m、NP 151W、均瓦 131W (1.98 W/kg，最大 197W，做功 319.4 kJ)、均心率 134 bpm (最高 157 bpm)、均踏頻 86 rpm (最大 95 rpm)、VI 1.15。核心 5 組 3 分鐘閾值間歇輸出分別為 181.6W、181.8W、181.7W、181.8W、181.8W，功率輸出極致穩定（誤差 < 0.2W），踏頻穩固於 87~89 rpm，心率解耦率僅 3.84% (<5% 頂級標準)，心血管耐受極佳且無疲勞漂移！今日晨跑加下午閾值單車單日合計斬獲 116.4 TSS、30.81 km！\n")
        p1_body.add_run("• 週二晨間 12.05km 跑步專項高水準間歇 (80.4 rTSS)：9/15 早晨順利完成 1 小時 24 分 33 秒 12.05 km 跑步專項課表 (原定 11.60km，距離達成率 103.9% 超額完成，TSS 達成率 97.6%)。均速 7:01/km (均速 8.55 km/h，最快 4:00/km)，均瓦 212W (3.20 W/kg，最大 400W，做功 1,077.9 kJ)，均心率 155 bpm (最高 191 bpm 深度刺激心肌收縮與攝氧能力)。多組 400m 間歇衝刺組均速飆出 3:45~3:55/km，衝刺步頻高達 180~188 spm (最高 214 spm)！平均觸地時間僅 249ms、垂直比 8.0% (<9% 頂級標準)，展現極致跑姿落地剛性與動態經濟性，體感自覺給出 5/5 極佳滿分！\n")
        p1_body.add_run("• 明日週三 50m 長池甜甜泳課動態排酸：明日排定 80 分鐘 50m 長池「甜甜課表」，善用長池水壓與浮力深度代謝今日下肢跑步與單車乳酸，持續鞏固 Sub-11 (1:53/100m) 流線型水感，可查閱儀表板 #swim 專區最新游泳技術文章。\n")
    elif week_num == 37:
