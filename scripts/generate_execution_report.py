...
def build_report(target_date: date):
    ...
    with open(md_path, "w", encoding="utf-8") as f:
        ...
        if week_num == 34:
            ...
            f.write(f"- **Build 1-1 第一建構期旗開得勝**：本週正式邁入專項建構期，截至週六已完成自行車 **{bike_act_km:.2f} km**、跑步 **{run_act_km:.2f} km**、游泳 **{swim_act_km:.2f} km**，三項累積總時長突破 10 小時 15 分，專項速度、閾值衝擊、轉換適應與流線水感全面開展！\n")
            ...
            f.write("- **週三 3,450m 甜甜泳課低心率流暢巡航**：9/2 游泳 70 分鐘 (均速 2:02.5/100m, 均心率 114 bpm, sTSS 97.8, 脫鉤率 -20.90% Spd:HR)，在低於乳酸閾值極省力狀態下維持流暢水感與核心流線型，並發揮極佳的下肢動態排酸效果。\n")
    ...
    if week_num == 34:
        ...
        p1_body.add_run(f"• Build 1-1 第一建構期旗開得勝：本週正式邁入專項建構期，截至週六已完成自行車 {bike_act_km:.2f} km、跑步 {run_act_km:.2f} km、游泳 {swim_act_km:.2f} km，三項累積總時長突破 10 小時 15 分，專項速度、閾值衝擊、轉換適應與流線水感全面開展！\n")
        ...
        p1_body.add_run("• 週三 3,450m 甜甜泳課低心率流暢巡航：9/2 游泳 70 分鐘 (均速 2:02.5/100m, 均心率 114 bpm, sTSS 97.8, 脫鉤率 -20.90% Spd:HR)，在低於乳酸閾值極省力狀態下維持流暢水感與核心流線型，並發揮極佳的下肢動態排酸效果。\n")
