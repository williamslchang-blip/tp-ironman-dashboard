...
def build_report(target_date: date):
    ...
    with open(md_path, "w", encoding="utf-8") as f:
        ...
        if week_num == 34:
            ...
            f.write("- **Base 3-4 (Recovery) 減量與超量吸收週扎實執行**：在控制總時數的同時，維持長距離耐力與關鍵轉換刺激，疲勞控制與體感維持極佳狀態。\n")
    ...
    if week_num == 34:
        ...
        p1_body.add_run("• Base 3-4 (Recovery) 減量與超量吸收週扎實執行：在控制總時數的同時，維持長距離耐力與關鍵轉換刺激，疲勞控制與體感維持極佳狀態。\n")
