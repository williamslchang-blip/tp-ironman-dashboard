...
def build_report(target_date: date):
    ...
    if week_num == 39:
        ...
        p1_body.add_run("• 週四晨間 50m 長池甜甜課表 3,250m (99.5 sTSS, IF 0.979) 頂尖長游：9/24 清晨 06:05 耗時 1 小時 03 分 37 秒完成 3,250 m（原定 75 分鐘，實游距離達標，sTSS 達 99.52）。全趟划水均速 1:57.8 /100m (標準化速度 1:57.4 /100m，均時速 3.06 km/h)；均心率僅 117 bpm (最高 190 bpm，低心率 Recovery 與 Endurance 區間佔比高達 86.2%)；均划頻 27 spm (最高 36 spm)；速度心率脫鉤率呈現極其驚人的負脫鉤 (Spd:HR -26.66%)！核心巡航亮點：400m 自由式巡航開出 1:40.0 /100m 整 (均心率僅 96 bpm！)、850m 長巡航游出 1:43.4 /100m (均心率僅 115 bpm！)，體感自覺給出良好的 3/5 與 RPE 5/10！在昨日 9.53km 高強度間歇跑後，成功善用長池水壓與浮力達成下肢深層動態排酸。\n")
        p1_body.add_run("• 週三晨間田徑場 5x1200m 漸進速度間歇 9.53km (55.5 rTSS, IF 0.706) 頂尖跑步專項：9/23 清晨 05:51 耗時 1 小時 00 分 16 秒完成 9.53 km（原定 60 分鐘 / 8.8 km，時間達成率 100.4% 精準達標，距離達成率 108.3% 超額完成，收穫 55.48 rTSS）。全趟標準化速度 5:40 /km (直擊 Sub-11 全馬 4 小時 5:41/km 目標配速線！)，均速 6:20 /km，均瓦 242W (3.58 W/kg，最大 420W)。全趟均心率 151 bpm (最高 183 bpm)；均步頻 146 spm (間歇跑動段 171~183 spm)；步態力學頂尖：觸地時間 251.2 ms，垂直比僅 8.0% (<9% 頂尖標竿，振幅 8.16cm、步幅 1.02m)，展現頂級能量轉換經濟性；核心 5 組 1200m 負分割間歇末圈開出 4:23/km (步頻 183 spm)！\n")
        p1_body.add_run("• 週二晨間 50m 長池甜甜課表 3,400m (113.7 sTSS, IF 1.023) 頂尖長游：9/22 清晨 06:06 耗時 1 小時 03 分 41 秒完成 3,400 m（sTSS 達 113.73，達成率 106.1%）。全趟划水均速 1:52.8 /100m (標準化速度 1:52.4 /100m，精準切中 Sub-11 游泳 1h12m 目標線！)。均心率僅 97 bpm，速度心率脫鉤率 Spd:HR -32.31%，流線型與抗疲勞水感卓越！\n")
