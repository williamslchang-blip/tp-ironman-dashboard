...
- 2026-08-02
- 2026-08-02 已更新 `scripts/fetch_weekly_articles.py` 與 `scripts/generate_articles_page.py`，實現每篇鐵人新知文章均提供雙重連結：「🌐 閱讀外網原始文章 ↗」與「📖 原文中譯與重點摘要」，並恪守著作權法合理使用原則（提供 100-200 字精華翻譯與觀點摘要，不提供逐字全篇翻譯）。
